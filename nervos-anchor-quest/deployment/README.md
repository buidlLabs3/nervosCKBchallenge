...
offckb deploy --network devnet --target <contract-binary-path> --output /home/core/Desktop/CKB/NervosCKBchallenge/nervos-anchor-quest/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /home/core/Desktop/CKB/NervosCKBchallenge/nervos-anchor-quest/deployment
```
